...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to="restaurants/category/", default='restaurants/category/default_image.jpeg')
    def __str__(self):
        return self.name
...
class Food(models.Model):
    ...
    image = models.ImageField(upload_to="restaurants/food/", default='restaurants/food/default_image.jpeg')
    def __str__(self):
            return self.name
...
class Restaurant(models.Model):
    ...
    image = models.ImageField(upload_to="restaurants/restaurant/", default='restaurants/restaurant/default_image.jpeg')
